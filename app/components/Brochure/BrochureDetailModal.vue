    ...
    <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
      ...
      <div class="inline-block w-full max-w-3xl p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-lg">
        ...
        <div class="flex items-center justify-between mb-6">
          <h2 class="text-2xl font-bold text-gray-900">Brochure Request Details</h2>
          <button
            @click="$emit('close')"
        ...
        <div v-if="brochure" class="space-y-6">
          ...
          <div class="bg-gray-50 rounded-lg p-4">
            <h3 class="text-lg font-medium text-gray-900 mb-4">Brochure Information</h3>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Brochure Name</label>
                <div class="flex items-center space-x-2">
                  <Icon name="mdi:file-document" class="w-5 h-5 text-gray-400" />
                  <span class="text-gray-900">{{ brochure.brochure_name }}</span>
                </div>
              </div>
              ...
              <div>
                ...
                <div class="flex items-center space-x-2">
                  ...
                  <span class="text-gray-900">{{ formatCourseType(brochure.course_type) }}</span>
                </div>
              </div>
              ...
              <div>
                ...
                <div class="flex items-center space-x-2">
                  ...
                  <span class="text-gray-900 font-mono text-sm">{{ brochure.contact_id }}</span>
                </div>
              </div>
              ...
              <div>
                ...
                <div class="flex items-center space-x-2">
                  <Icon
                    :name="brochure.email_sent ? 'mdi:email-check' : 'mdi:email-clock'"
                    :class="[
                      'w-5 h-5',
                      brochure.email_sent ? 'text-green-500' : 'text-yellow-500'
                    ]"
                  />
          ...
          <div v-if="brochure.email_sent_at" class="bg-gray-50 rounded-lg p-4">
            <h3 class="text-lg font-medium text-gray-900 mb-4">Email Delivery Details</h3>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Delivered At</label>
                <div class="flex items-center space-x-2">
                  <Icon name="mdi:calendar-check" class="w-5 h-5 text-gray-400" />
                  <span class="text-gray-900">
          ...
          <div class="bg-gray-50 rounded-lg p-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <div class="flex items-center space-x-2">
                  <Icon name="mdi:calendar-plus" class="w-5 h-5 text-gray-400" />
                  <span class="text-gray-900">
              ...
              <div v-if="brochure.updated_at !== brochure.created_at">
                ...
                <div class="flex items-center space-x-2">
                  <Icon name="mdi:calendar-edit" class="w-5 h-5 text-gray-400" />
                  <span class="text-gray-900">
