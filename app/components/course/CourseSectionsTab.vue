          ...
          >
            <div class="flex items-center justify-between">
              <div class="flex items-center gap-3 flex-1">
                ...
                <div class="flex-1">
                  ...
                  <input
                    ...
                    @keyup.enter="$emit('saveSection', section.id, editingSectionTitle)"
              ...
              <div class="flex items-center gap-2 ml-4">
                ...
                <button
                  v-if="editingSection !== section.id && sectionIndex < (course?.sections?.length || 0) - 1"
          ...
          <div v-if="section.lessons?.length" class="p-4 space-y-2">
            ...
            >
              ...
              <div class="flex items-center gap-1">
                ...
                <button
                  v-if="lessonIndex > 0"
                  @click="$emit('moveLessonUp', section.id, lesson, lessonIndex)"
                ...
                <button
                  ...
                  @click="$emit('moveLessonDown', section.id, lesson, lessonIndex)"
                  class="p-1 text-gray-500 hover:text-brand dark:hover:text-brand hover:bg-gray-100 dark:hover:bg-gray-700 rounded transition-all"
                  title="Move down"
                >
