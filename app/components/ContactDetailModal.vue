      ...
      <div class="inline-block w-full max-w-2xl p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-lg">
        ...
        <div v-if="contact" class="space-y-6">
          ...
          <div class="flex items-center space-x-3">
            ...
            >
              {{ contact.form_type === 'contact' ? 'Contact Form Submission' : 'Brochure Request' }}
            </span>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <div class="flex items-center space-x-2">
                  ...
                  <span class="text-gray-900">{{ formatCourseInterest(contact.course_interest) }}</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div v-if="contact.message" class="bg-gray-50 rounded-lg p-4">
            ...
            <div class="flex items-start space-x-3">
              <Icon name="mdi:message-text" class="w-5 h-5 text-gray-400 flex-shrink-0 mt-0.5" />
          ...
          <div class="flex justify-end space-x-3 pt-4 border-t border-gray-200">
            <a
              :href="`mailto:${contact.email}?subject=Re: ${contact.form_type === 'contact' ? 'Your inquiry' : 'Brochure request'} - Teknikoz University`"
