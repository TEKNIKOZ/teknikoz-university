  ...
  <section class="py-16 px-4 bg-gray-50">
    <div class="max-w-7xl mx-auto">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
        <!-- Real World Projects -->
        <div class="bg-white rounded-2xl border border-gray-200 p-8 text-center hover:shadow-lg transition-shadow duration-300">
          <div class="w-20 h-20 bg-purple-500 rounded-full flex items-center justify-center mx-auto mb-6">
            <Icon name="mdi:check" class="text-white text-3xl" />
          </div>
        ...
        <div class="bg-white rounded-2xl border border-gray-200 p-8 text-center hover:shadow-lg transition-shadow duration-300">
          <div class="w-20 h-20 bg-green-500 rounded-full flex items-center justify-center mx-auto mb-6">
            <Icon name="mdi:file-document-edit" class="text-white text-3xl" />
          </div>
          <h3 class="text-xl font-bold text-gray-900 mb-3">
        ...
        <div class="bg-white rounded-2xl border border-gray-200 p-8 text-center hover:shadow-lg transition-shadow duration-300">
          <div class="w-20 h-20 bg-orange-500 rounded-full flex items-center justify-center mx-auto mb-6">
            <Icon name="mdi:briefcase" class="text-white text-3xl" />
          </div>
          <h3 class="text-xl font-bold text-gray-900 mb-3">
